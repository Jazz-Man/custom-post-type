...
class CustomPostType
{
    ...
    public function __construct($post_type_names, array $options = [])
    {
        ...
        $this->add_filter('manage_edit-'.$this->post_type.'_columns', [&$this, 'add_admin_columns']);
        $this->add_action(
            'manage_'.$this->post_type.'_posts_custom_column',
            [&$this, 'populate_admin_columns'],
            10,
            2
        );
    ...
    public function get_human_friendly($name = null)
    {
        ...
        return \ucwords(mb_strtolower(\str_replace('-', ' ', \str_replace('_', ' ', $name))));
    }
    ...
    {
        $this->add_action("save_post_$this->post_type", $callback, $priority, $accepted_args);
    }

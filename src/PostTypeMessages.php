...
final class PostTypeMessages implements AutoloadInterface {
    ...
    public function load(): void {
        add_filter(
            ...
            static fn ( array $messages = [] ): array => self::updatedMessages( $messages )
        );
        add_filter(
            'bulk_post_updated_messages',
            static fn ( array $messages = [], array $counts = [] ): array => self::bulkUpdatedMessages( $messages, $counts ),
            10,
            2
        );
    }
     ...
     */
    private static function getPostTypeLabelForMessages(): array|bool {
